...
```{r gitHubFlow, echo=FALSE}
knitr::include_url("https://guides.github.com/introduction/flow/", height = "500px")
...
```{r gitJenny, fig.cap="Connecting RStudio to Git and GitHub. An awesome resource by Jenny Bryan and Jim Hester.", echo=FALSE}
...
.pull-left[
- Please do not hesitate to contact Dr. Jones-Farmer or myself if you have questions pertaining to GitHub.  For my contact information, see:  
  * <a href="mailto:fmegahed@miamioh.edu"><i class="fa fa-paper-plane fa-fw"></i>&nbsp; fmegahed@miamioh.edu</a>  
  * <a href="https://calendly.com/fmegahed/"><i class="fa fa-question"></i>&nbsp; Schedule a Virtual Meeting</a>
...
- Slides were created via the R package **xaringan**.
]


.pull-right[
<img src="https://www.verouden.net/slides/presentation-xaringan/img/questions.gif" width="300" height="300" />
]